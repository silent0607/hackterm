...
const toolsConfig = {
  ...
  wireshark: { check: () => { try { execSync('ls /usr/bin/wireshark'); return true; } catch{ return false; } }, cmd: 'echo "wireshark-common wireshark-common/install-setuid boolean true" | debconf-set-selections && apt-get update && apt-get install -y wireshark' },
